const split = require('./aulaModulos/modulos/split');

console.log( split(456.43, 6, 15) );
console.log( split(2897.12, 2, 10) );
...
// Você pode imaginar em quais casos, ou programas, a criação de módulos poderia nos resolver
// e até mesmo nos salvar de grandes problemas?
